...
public class RekeningBank {
    ...
    /**
     * Constructor ringkas. TODO 3: DELEGASIKAN ke constructor lengkap dengan
     * this(...). Jangan menyalin validasi ke sini.
     */
    ...
    public void setor(double jumlah) {
        ...
        if (jumlah <= 0) {
            throw new IllegalArgumentException("Jumlah setoran harus bernilai positif.");
        }
        this.saldo += jumlah;
    }
    ...
    public void tarik(double jumlah) {
        ...
        if (jumlah <= 0) {
            throw new IllegalArgumentException("Jumlah penarikan harus bernilai positif.");
        }
        if (jumlah > BATAS_PENARIKAN_SEKALI) {
            throw new IllegalArgumentException("Penarikan melebihi batas sekali transaksi.");
        }
    ...
    public void potongBiayaAdmin() {
        if (this.saldo >= BIAYA_ADMINISTRASI) {
            this.saldo -= BIAYA_ADMINISTRASI;
        } else {
            this.saldo = 0;
        }
    }
     ...
     * Perhatikan: method ini tidak membaca keadaan objek mana pun. Itulah
     * alasan ia pantas menjadi static.
     */
